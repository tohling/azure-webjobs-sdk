...
{
    /// <summary>
    /// Provide configuration for EventHubStreamListener. 
    /// </summary>
    public class EventHubStreamListenerConfiguration
    {
        /// <summary>
        /// The EventHubStreamListenerConfiguration
        /// </summary>
        ...
        public EventHubStreamListenerConfiguration(bool isSingleDispatch, TimeSpan maxElapsedTime, int maxDop, int boundedCapacity, int batchCheckpointFrequency)
        {
